  ...
  render() {
    ...
    const MAP = {
      ...
      areas: [
        ...
        {name: 'The Rapids', id: 9, shape: 'poly', coords: [509, 161, 526, 171, 538, 182, 548, 197, 558, 210, 568, 220, 574, 229, 582, 258, 598, 277, 610, 288, 611, 297, 628, 295, 620, 287, 618, 279, 603, 266, 597, 261, 593, 241, 585, 222, 573, 211, 562, 198, 556, 192, 551, 180, 536, 167, 526, 157, 517, 152, 509, 145], fillColor: 'rgb(255, 209, 0, 0.8)'},
      ]
    };
    return (
      <div>
