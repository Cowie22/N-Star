  ...
  render() {
    ...
    const MAP = {
      ...
      areas: [
        ...
        {name: 'Main Lodge', place_id: 1, shape: 'poly', coords: [127, 441, 99, 461, 148, 462, 148, 440, 127, 441], fillColor: 'rgb(255, 209, 0, 0.8)'},
        {name: 'Zephyr Lodge', place_id: 2, shape: 'poly', coords: [465, 301, 464, 321, 485, 320, 485, 302, 465, 301], fillColor: 'rgb(255, 209, 0, 0.8)'},
        {name: 'Comstock Lodge', place_id: 3, shape: 'poly', coords: [487, 71, 487, 93, 508, 93, 508, 73, 488, 71], fillColor: 'rgb(255, 209, 0, 0.8)'},
        {name: 'Backside Lodge', place_id: 4, shape: 'poly', coords: [530, 71, 530, 91, 552, 91, 552, 71, 531, 72], fillColor: 'rgb(255, 209, 0, 0.8)'},
        {name: 'Lookout Tables', place_id: 5, shape: 'poly', coords: [548, 293, 547, 313, 568, 313, 568, 293, 548, 293], fillColor: 'rgb(255, 209, 0, 0.8)'},
        {name: 'Logers Loop Tables', place_id: 6, shape: 'poly', coords: [147, 182, 147, 202, 168, 203, 168, 182, 147, 181], fillColor: 'rgb(255, 209, 0, 0.8)'},
        {name: 'Village', place_id: 7, shape: 'poly', coords: [78, 593, 78, 613, 99, 613, 99, 593, 79, 593], fillColor: 'rgb(255, 209, 0, 0.8)'},
      ]
    };
    return (
      <div>
